...
# Movendo o diretório dos scripts do pipeline do qiime para /usr/local/bioinfo/qiime_examples
sudo mv /tmp/scripts_qiime-master /usr/local/bioinfo/qiime_examples
...
sudo mv /tmp/MiSeq_SOP/F3D0_S188_L001_R1_001.fastq /usr/local/bioinfo/qiime_examples/scripts_qiime-master/examples/4_pe_fq_raw
sudo mv /tmp/MiSeq_SOP/F3D0_S188_L001_R2_001.fastq /usr/local/bioinfo/qiime_examples/scripts_qiime-master/examples/4_pe_fq_raw

sudo mv /tmp/MiSeq_SOP/F3D1_S189_L001_R1_001.fastq /usr/local/bioinfo/qiime_examples/scripts_qiime-master/examples/4_pe_fq_raw
sudo mv /tmp/MiSeq_SOP/F3D1_S189_L001_R2_001.fastq /usr/local/bioinfo/qiime_examples/scripts_qiime-master/examples/4_pe_fq_raw

sudo mv /tmp/MiSeq_SOP/F3D5_S193_L001_R1_001.fastq /usr/local/bioinfo/qiime_examples/scripts_qiime-master/examples/4_pe_fq_raw
sudo mv /tmp/MiSeq_SOP/F3D5_S193_L001_R2_001.fastq /usr/local/bioinfo/qiime_examples/scripts_qiime-master/examples/4_pe_fq_raw

sudo mv /tmp/MiSeq_SOP/F3D150_S216_L001_R1_001.fastq /usr/local/bioinfo/qiime_examples/scripts_qiime-master/examples/4_pe_fq_raw
sudo mv /tmp/MiSeq_SOP/F3D150_S216_L001_R2_001.fastq /usr/local/bioinfo/qiime_examples/scripts_qiime-master/examples/4_pe_fq_raw
