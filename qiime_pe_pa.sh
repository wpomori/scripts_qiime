...
#
# Script versão 0.03, terminado dia 07/12/2016 ás 16:36h. Parte deste shell
...
# http://neufeldserver.uwaterloo.ca/~apmasell/pandaseq_man1.html
	pandaseq -f ${raw_data}/${file}R1_001.fastq -r ${raw_data}/${file}R2_001.fastq -w ${panda}/${file}merged.fasta -g ${panda}/${file}merged.log -B -F -A simple_bayesian
